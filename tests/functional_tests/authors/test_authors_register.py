...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_user_valid_data_register_sucessfully(self):
        ...
        self.get_by_placeholder(form, 'Ex.: John').send_keys('Eduardo')
        self.get_by_placeholder(form, 'Ex.: Doe').send_keys('Junior')
        self.get_by_placeholder(form, 'Your username').send_keys('EduardoJr')
        self.get_by_placeholder(
            form, 'Your e-mail').send_keys('eduardo@gmail.com')
        self.get_by_placeholder(
